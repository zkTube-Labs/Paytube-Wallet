 ...
 */
public class ShopReturnJSBean implements Serializable{
    ...
    public static class DataBean implements Serializable {
        ...
        private ArrayList<String> vnsAddress;// 所有钱包的vns地址

        public ArrayList<String> getVnsAddress() {
            return vnsAddress;
        }

        public void setVnsAddress(ArrayList<String> vnsAddress) {
            this.vnsAddress = vnsAddress;
        }
