...
//@property (strong, nonatomic)   LoadingGifView * gifView ;
/**
 @brief  启动相机中的提示文字
 */
...
//        _gifView = [LoadingGifView showLoadingWithCoinIDlogo:CGRectMake(0, 0, 50, 50)];
...
//        _gifView.bounds = CGRectMake(0, 0, 30, 30);
//        if (text)
//            _gifView.center = CGPointMake(centerPt.x - frame.size.width/2 - 24 , _labelReadying.center.y);
//        else
//            _gifView.center = CGPointMake(self.frame.size.width/2 , _labelReadying.center.y);
        
        [self addSubview:_activityView];
        [self addSubview:_labelReadying];
        [_activityView startAnimating];
    }
//    [_gifView showLoadingLogo];
}
...
//        CGContextSetStrokeColorWithColor(context, _viewStyle.colorRetangleLine.CGColor);
        CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:136/255.0 green:136/255.0 blue:136/255.0 alpha:1].CGColor);
